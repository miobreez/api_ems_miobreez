...
> Порядок значений строго соответствует зонам устройства.
...
### 📍 Порядок каналов (индексы массива)
...
| 7 | Поясница |
| 8 | Ягодицы |
| 9 | Задняя часть бедра |

⚠️ Важно: длина списка всегда должна быть **ровно 10 элементов**.  
Максимальное значение каждого канала — **100**.
